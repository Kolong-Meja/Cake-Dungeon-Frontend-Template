<script lang="ts">
	...
	const categories = ['cakes', 'cookies', 'ice cream'];
		...
		<div class="py-24 px-20 max-w-screen-xl">
			<div class="flex flex-col items-center space-y-20">
				...
				<div class="flex flex-col items-center space-y-2">
					...
					<p class="text-3xl font-semibold text-light-cream self-center">
	...
	<div class="py-12 px-8 max-w-screen-xl">
		<div class="flex flex-row items-center space-x-10">
			<div class="flex flex-col items-start space-y-7 p-3">
				<h1 class="text-6xl font-bold text-gray-900 uppercase">Welcome to cake dungeon</h1>
				<p class="text-2xl font-normal leading-normal text-gray-900">
				...
				<a
					href="/cakes"
					class="inline-flex items-center p-3 text-sm font-medium text-center text-white bg-dark-cocoa rounded-lg hover:bg-cocoa focus:ring-4 focus:outline-none focus:ring-blue-300 transition-all duration-300 ease-in-out"
				>
					<span class="font-bodoni text-light-cream text-lg">Start Explore</span>
				</a>
			</div>
			<img src={WelcomeSectionPicture} alt="cake" class="rounded-lg w-[36rem] h-[36rem]" />
		</div>
	</div>
</Section>
			...
			<div class="flex flex-row items-center space-x-10">
				{#each categories as category}
					<div class="max-w-xs h-full bg-light-cream bg-center border-0 rounded-lg">
						{#if category === 'cakes'}
							<img src={ChocolateCakePicture} alt={category} />
							<div class="p-5">
								<a href={'#'}>
									<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 uppercase">
										Cakes
									</h5>
								</a>
								<p class="mb-3 font-normal text-gray-700">
									Cake Dungeon offers <span class="font-bold underline">Cake</span> variants that are
									unique and delicious to your taste buds. What are you waiting for? Come on, order now!
								</p>
								<a
									href={'#'}
									class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-dark-cocoa rounded-lg hover:bg-cocoa focus:ring-4 focus:outline-none focus:ring-blue-300 transition-all duration-300 ease-in-out"
								>
									Order Now
									<svg
						...
						{/if}
						{#if category === 'cookies'}
							<img src={CookiesPicture} alt={category} />
							<div class="p-5">
								<a href={'#'}>
									<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 uppercase">
										Cookies
								...
								<p class="mb-3 font-normal text-gray-700">
									Cake Dungeon offers <span class="font-bold underline">Cookie</span> variants that are
									unique and delicious to your taste buds. What are you waiting for? Come on, order now!
								</p>
								<a
									href={'#'}
						...
						{#if category === 'ice cream'}
							<img src={IceCreamPicture} alt={category} />
							<div class="p-5">
								<a href={'#'}>
									<h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 uppercase">
										Ice Creams
								...
								<p class="mb-3 font-normal text-gray-700">
									Cake Dungeon offers <span class="font-bold underline">Ice Cream</span> variants that
									are unique and delicious to your taste buds. What are you waiting for? Come on, order
									now!
								</p>
								<a
									href={'#'}
